...
const steps = [
    {
        ...
        description: "Comprehensive research to identify market opportunities, competitive positioning and entry feasibility across targeted international regions.",
        link: "#!",
    ...
    },
    {
        ...
        description: "Development of a structured expansion strategy including value proposition, target segmentation and competitive differentiation.",
        link: "#!",
    ...
    },
    {
        ...
        description: "Execution of the market entry plan followed by performance evaluation, optimization and scalable growth initiatives.",
        link: "#!",
...
export default function WorkflowSteps() {
    ...
    description="A structured international expansion framework designed to ensure sustainable market growth."
/>
