    ...
    <section className="relative min-h-screen px-6 py-32 bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-32">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <p>
              <strong className="text-white">THINK FAST SHOW</strong> is a new live
              entertainment concept in Dublin that focuses on spontaneity,
              intimacy and pure talent.
            </p>

            <p>
              We are a team of actors specialising in improvisation who make every
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              To create memorable improvisational theatre experiences, live or via streaming,
              celebrating connection, talent and spontaneity.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              To redefine live entertainment in the digital age,
              where theatre transcends physical space and technology enhances connection.
            </p>
          </motion.div>
        ...
        >
          <img
            ...
            alt="Think Fast Team"
            className="rounded-3xl border border-white/10 max-w-4xl w-full"
          />
        </motion.div>
